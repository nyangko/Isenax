...
### ভিউয়ের মধ্যে চলাচল
লেয়ার প্যানেলে এখন "ভিউ" ট্যাব আছে, যেখানে ডায়াগ্রামের সব ভিউ ট্রি আকারে দেখা যায় — এক ধাপ করে উপরে না উঠে সরাসরি যেকোনো ভিউতে যাওয়া যায়, আর প্যানেলের হেডারে আপনার সম্পূর্ণ পথ ক্লিকযোগ্য ব্রেডক্রাম্ব হিসেবে দেখানো হয়। যেসব নোডের চাইল্ড ভিউ আছে সেগুলো ক্যানভাসে চিহ্নিত থাকে এবং ডাবল-ক্লিকে খোলে, ভিউ বদলানোর সময় অ্যানিমেশন চলে, এবং প্রতিটি সারির মেনু থেকে ভিউয়ের নাম বদলানো বা মুছে ফেলা যায়।

### বিস্তারিত ভিউতে ড্রিল-ডাউন
একটি নোডে রাইট-ক্লিক করুন (মোবাইলে লং-প্রেস) → "চাইল্ড ভিউ তৈরি করুন" নির্বাচন করে সেই আইটেমের নিজস্ব বিস্তারিত ডায়াগ্রামে জুম করুন। অ্যাঙ্কর আইকনটি জায়গায় লক থাকে এবং মুছে ফেলা যায় না, তাই আপনি সবসময় জানেন এটি কার ভিউ, আর লেয়ার প্যানেলের হেডার একই সাথে ব্যাক বাটন হিসেবেও কাজ করে। লেয়ার প্যানেলের প্রতিটি নোড সারিতেও এখন একই কাজের জন্য নিজস্ব তৈরি/খোলা আইকন আছে।

### স্পষ্ট সিলেকশন ফিডব্যাক
একটি নোড নির্বাচন করলে এখন বাকি সব নোড ম্লান হয়ে যায় যাতে নির্বাচিতটি স্পষ্ট বোঝা যায়, একটি কানেক্টর নির্বাচন করলে শুধু এর প্রান্ত নয়, লাইনটি নিজেও ক্যানভাসে হাইলাইট হয়, আর লেয়ার প্যানেলে আগে থেকে নির্বাচিত সারিতে আবার ক্লিক করলে নির্বাচন বাতিল হয়ে যায়।

### মোবাইলে রেসপন্সিভ টুলবার ও সেটিংস
সংকীর্ণ স্ক্রিনে উপরের টুলবার এখন সংরক্ষিত পজিশন সেটিং নির্বিশেষে স্বয়ংক্রিয়ভাবে হরাইজন্টাল লেআউটে পরিবর্তিত হয়, আর সেটিংসও মোবাইলে ফুলস্ক্রিন খোলে, সাইডবার তালিকার বদলে হরাইজন্টালি স্ক্রলযোগ্য আইকন-স্ট্রিপ নেভিগেশন ব্যবহার করে।

### নতুনভাবে ডিজাইন করা সেটিংস
সার্চযোগ্য (⌘K), দুই-প্যানেলের সেটিংস ডায়ালগ পুরনো ট্যাব স্ট্রিপের জায়গা নিয়েছে — শর্টকাট/প্যান/জুম, ডিসপ্লে, আইকন প্যাক এবং এক্সটেনশন এই ভাগে সাজানো, প্রতিটি সেকশনে Cancel/Save লজিক এবং একটি "ডিফল্টে ফিরিয়ে দিন" বাটনসহ।

### লেয়ার প্যানেল
সার্চ ও টাইপ ফিল্টার (সব/নোড/সংযোজক/এরিয়া/টেক্সট), নোডগুলো এখন যে এরিয়ার ভেতরে থাকে তার নিচে নেস্টেড দেখা যায়, প্রতিটি আইটেমের জন্য show/lock টগল, আর প্যানেল এখন স্ক্রিনের কিনারা ঘেঁষে ডক করে, সাথে টুলবারের অবস্থানও কনফিগার করা যায়।

### নোড এডিট প্যানেল
বড় আইকন, সিলেকশন ব্যাজ, জোন/কানেকশন/টাইপ চিপস, একটি লেবেল ডিসপ্লে মোড (সবসময়/হোভারে/লুকানো), এবং ক্লিক করলে ক্যানভাসকে সংযুক্ত নোডে নিয়ে যাওয়া কানেকশন সামারিসহ নতুনভাবে ডিজাইন করা সামারি কার্ড।

### MCP টুল ইন্টিগ্রেশন
সেটিংস → MCP প্যানেল এখন সেই টুলগুলো ( list/get/create/update/patch/delete diagram) তালিকাভুক্ত করে যা সংযুক্ত একটি AI এজেন্ট কল করতে পারে।

### আইকন প্যাক ব্র্যান্ড লোগো
AWS, GCP, Azure ও Kubernetes আইকন প্যাক এখন সেটিংসে একটি সাধারণ ইনিশিয়াল ব্যাজের বদলে তাদের আসল ব্র্যান্ড লোগো দেখায়।
