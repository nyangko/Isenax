...
const locale: LocaleProps = {
  ...
  viewControls: {
    ...
    childViewHintBody: "Usa il percorso qui sopra per tornare a una qualsiasi vista precedente.",
  ...
  layersPanel: {
    ...
    viewDeleteConfirm: "Eliminare \"{name}\" e tutto il suo contenuto?",
    viewDeleteSummary: "{items} elementi, {views} viste annidate",
    viewDeleteCancel: "Annulla",
