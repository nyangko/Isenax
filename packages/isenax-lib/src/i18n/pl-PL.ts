...
const locale: LocaleProps = {
  ...
  layersPanel: {
    ...
    subTabViews: "Widoki",
    viewRename: "Zmień nazwę",
    viewDelete: "Usuń widok",
    viewDeleteConfirm: "Usunąć „{name}” i całą jego zawartość?",
    viewDeleteSummary: "Elementy: {items}, widoki zagnieżdżone: {views}",
    viewDeleteCancel: "Anuluj",
