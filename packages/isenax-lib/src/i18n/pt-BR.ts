...
const locale: LocaleProps = {
  ...
  contextMenu: {
    ...
    childViewName: "Detalhe de {name}",
    createChildView: "Criar visualização filha",
    openChildView: "Abrir visualização filha",
    editNode: "Editar nó",
  ...
  layersPanel: {
    ...
    subTabViews: "Visualizações",
    viewRename: "Renomear",
    viewDelete: "Excluir visualização",
    viewDeleteConfirm: "Excluir \"{name}\" e todo o seu conteúdo?",
    viewDeleteSummary: "{items} itens, {views} visualizações aninhadas",
