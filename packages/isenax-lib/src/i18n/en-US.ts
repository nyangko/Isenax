...
const locale: LocaleProps = {
  ...
  viewControls: {
    ...
    childViewHintTitle: "You're in a detail view",
    childViewHintBody: "Use the path above to jump back to any view it came from.",
  ...
  contextMenu: {
    ...
    childViewName: "{name} Detail",
    createChildView: "Create Child View",
    openChildView: "Open Child View",
    editNode: "Edit Node",
  ...
  layersPanel: {
    ...
    viewDeleteConfirm: "Delete \"{name}\" and everything in it?",
    viewDeleteSummary: "{items} items, {views} nested views",
    viewDeleteCancel: "Cancel",
