...
const locale: LocaleProps = {
  ...
  layersPanel: {
    ...
    viewRename: "Yeniden adlandır",
    viewDelete: "Görünümü sil",
    viewDeleteConfirm: "\"{name}\" ve içindeki her şey silinsin mi?",
    viewDeleteSummary: "{items} öğe, {views} iç görünüm",
    viewDeleteCancel: "İptal",
