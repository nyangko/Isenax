...
const locale: LocaleProps = {
  ...
  viewControls: {
    ...
    childViewHintBody: "Usa la ruta de arriba para volver a cualquier vista anterior.",
  ...
  layersPanel: {
    ...
    subTabViews: "Vistas",
    viewRename: "Cambiar nombre",
    viewDelete: "Eliminar vista",
    viewDeleteConfirm: "¿Eliminar \"{name}\" y todo su contenido?",
    viewDeleteSummary: "{items} elementos, {views} vistas anidadas",
    viewDeleteCancel: "Cancelar",
