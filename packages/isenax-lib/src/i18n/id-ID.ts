...
const locale: LocaleProps = {
  ...
  viewControls: {
    ...
    childViewHintBody: "Gunakan jalur di atas untuk kembali ke tampilan induk mana pun.",
  ...
  layersPanel: {
    ...
    viewRename: "Ganti nama",
    viewDelete: "Hapus tampilan",
    viewDeleteConfirm: "Hapus \"{name}\" beserta seluruh isinya?",
    viewDeleteSummary: "{items} item, {views} tampilan bertingkat",
    viewDeleteCancel: "Batal",
