...
const locale: LocaleProps = {
  ...
  layersPanel: {
    ...
    subTabViews: "व्यू",
    viewRename: "नाम बदलें",
    viewDelete: "व्यू हटाएँ",
    viewDeleteConfirm: "\"{name}\" और उसमें मौजूद सब कुछ हटाएँ?",
    viewDeleteSummary: "{items} आइटम, {views} नेस्टेड व्यू",
    viewDeleteCancel: "रद्द करें",
