...
const locale: LocaleProps = {
  ...
  layersPanel: {
    ...
    subTabViews: "Виды",
    viewRename: "Переименовать",
    viewDelete: "Удалить вид",
    viewDeleteConfirm: "Удалить «{name}» и всё его содержимое?",
    viewDeleteSummary: "Элементов: {items}, вложенных видов: {views}",
    viewDeleteCancel: "Отмена",
