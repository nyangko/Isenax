...
const locale: LocaleProps = {
  ...
  viewControls: {
    ...
    childViewHintBody: "Utilisez le chemin ci-dessus pour revenir à n'importe quelle vue parente.",
  ...
  layersPanel: {
    ...
    viewDeleteConfirm: "Supprimer « {name} » et tout son contenu ?",
    viewDeleteSummary: "{items} éléments, {views} vues imbriquées",
    viewDeleteCancel: "Annuler",
