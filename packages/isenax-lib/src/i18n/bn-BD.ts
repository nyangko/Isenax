...
const locale: LocaleProps = {
  ...
  viewControls: {
    backToParentView: "প্যারেন্ট ভিউতে ফিরে যান",
    childViewHintTitle: "আপনি একটি বিস্তারিত ভিউতে আছেন",
    childViewHintBody: "উপরের পথ ব্যবহার করে যেকোনো উপরের ভিউতে ফিরে যেতে পারেন।",
  ...
  contextMenu: {
    ...
    childViewName: "{name} বিবরণ",
    createChildView: "চাইল্ড ভিউ তৈরি করুন",
    openChildView: "চাইল্ড ভিউ খুলুন",
  ...
  layersPanel: {
    ...
    subTabViews: "ভিউ",
    viewRename: "নাম পরিবর্তন",
    viewDelete: "ভিউ মুছুন",
    viewDeleteConfirm: "\"{name}\" এবং এর ভেতরের সবকিছু মুছে ফেলবেন?",
    viewDeleteSummary: "{items}টি আইটেম, {views}টি নেস্টেড ভিউ",
    viewDeleteCancel: "বাতিল",
